# Introduction to Programming - Evaluatie Augustus 2023
...
5. Kopieer de ssh clone-url (groene knop) die eruit zoiets als `git@github.com:vives-intro-to-programming-2022-2023/csharp-evaluation-intro-augustus-2023-<username>.git`
...
```text
Cloning into 'csharp-evaluation-intro-augustus-2023-BioBoost'...
...
Ga naar je lokale kopie van de repository en start PowerShell hier op. Zorg dat je in de directory `csharp-evaluation-intro-augustus-2023-<username>` zit.
...
| --- | --- | :---: |
| [Rolling on the Floor](./rolling_on_the_floor/README.md) | Maken van afkortingen | `33%` |
| [Thats a Small Number](./thats_a_small_number/README.md) | Kleinste getal in een array | `33%` |
| [Palindrome](./Palindrome/README.md) | Controleer of een tekst een palindroom is | `34%` |
